defmodule GandalfWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GandalfWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GandalfWeb.Gettext, "errors", msg, opts)
    end
  end
